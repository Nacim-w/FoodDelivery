...
const GET_STORIES_ENDPOINT = '/api/all-stories';
...
class HomeService {
  ...
  Future<List<StoryItemModel>> getStories() async {
    try {
      final uri = Uri.parse('${NetworkConstants.baseUrl}$GET_STORIES_ENDPOINT');
