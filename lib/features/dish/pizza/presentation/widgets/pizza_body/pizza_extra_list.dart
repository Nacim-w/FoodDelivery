...
class PizzaExtraList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text('Extras', style: TextStyles.titleSemiBoldTiny.red0),
        ...List.generate(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text(
                      '59 CFA',
                      style: TextStyles.textMedium.red0,
                    ),
                    Transform.scale(
                      scale: 1,
                      child: Checkbox(
                        ...
                        onChanged: (value) =>
                            provider.toggleExtra(index, value!),
                        ...
                        activeColor: Colours.lightThemeRed0,
                      ),
                    ),
                  ],
                ),
