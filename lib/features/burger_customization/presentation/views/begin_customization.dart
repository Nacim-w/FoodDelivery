        ...
        Container(
          ...
          child: Column(
            children: [
                        ...
                        child: Stack(
                          ...
                          children: [
                            if (selectedIngredients
                                .contains(Media.burgerBottomBun))
                              Positioned(
                                bottom: 0,
                                child: Image.asset(
                                  Media.burgerBottomBun,
              ...
              BurgerChoices(onIngredientSelected: addIngredient),
            ],
          ),
        ),
              ...
              builder: (context, candidateData, rejectedData) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: isHovering ? Colors.red[400] : Colors.grey[850],
                    borderRadius: BorderRadius.circular(20),
                  ),
                  child: Column(
                    children: [
                      ...
                      Text(
                        isHovering ? "Relâche ici" : "Jette ici",
...
class _BurgerChoicesState extends State<BurgerChoices> {
  ...
  final Map<String, List<Map<String, String>>> choicesByCategory = {
    ...
    'Garnitures': [
      ...
      {'image': Media.burgerPlacedTomato, 'label': 'Tomate'},
    ],
    'Sauces': [
      {'image': Media.burgerBun3, 'label': 'Ketchup'},
      {'image': Media.burgerBun4, 'label': 'Mayonnaise'},
      {'image': Media.burgerBun5, 'label': 'Barbecue'},
      {'image': Media.burgerBun1, 'label': 'Moutarde'},
    ],
  };
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: choicesByCategory[selectedCategory]!
                  .map((item) =>
                      _draggableIngredient(item['image']!, item['label']!))
                  .toList(),
            ),
          ),
          const SizedBox(height: 8),
  ...
  Widget _draggableIngredient(String imagePath, String label) {
    return Draggable<String>(
      ...
      childWhenDragging: Opacity(
        opacity: 0.4,
        child: _ingredientItem(imagePath, label),
      ),
      child: GestureDetector(
        onTap: () {
