...
class DessertRestaurant extends StatefulWidget {
  final String image;
  final String title;
  ...
  @override
  State<DessertRestaurant> createState() => _DessertRestaurantState();
}

class _DessertRestaurantState extends State<DessertRestaurant> {
  @override
